...
| 2 | [SigLIP tuning](2-SigLIP-tuning/) — unfreeze the vision tower, to decide whether `laya-vision` is undertrained or structurally limited | code landed and smoke-tested, E5–E7 not run; branch `sb/vision` | [`siglip-tuning.md`](2-SigLIP-tuning/siglip-tuning.md) |
