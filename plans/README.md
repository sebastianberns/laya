...
| 2 | [SigLIP tuning](2-SigLIP-tuning/) — unfreeze the vision tower, to decide whether `laya-vision` is undertrained or structurally limited | run and measured, **PARTIAL**; not published; branch `sb/vision` | [`report.md`](2-SigLIP-tuning/report.md) |
